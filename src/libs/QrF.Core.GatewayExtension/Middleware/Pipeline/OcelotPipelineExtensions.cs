...
namespace QrF.Core.GatewayExtension.Middleware.Pipeline
{
    ...
    {
        public static OcelotRequestDelegate BuildExtOcelotPipeline(this IOcelotPipelineBuilder builder,
            OcelotPipelineConfiguration pipelineConfiguration)
        {
            ...
            builder.UseDiffClientRateLimitMiddleware(); // 添加自定义限流中间件
            builder.UseCusAuthenticationMiddleware(); // 添加自定义授权中间件
