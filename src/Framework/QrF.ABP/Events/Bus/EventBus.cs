...
using QrF.ABP.Events.Bus.Factories;
using QrF.ABP.Events.Bus.Factories.Internals;
using QrF.ABP.Events.Bus.Handlers;
using QrF.ABP.Events.Bus.Handlers.Internals;
using QrF.ABP.Extensions;
using QrF.ABP.Threading;
using QrF.ABP.Threading.Extensions;
using System;
            ...
            foreach (var handlerFactories in GetHandlerFactories(eventType))
            {
                foreach (var handlerFactory in handlerFactories.EventHandlerFactories)
                {
                    ...
                    else
                    {
                        ...
                        exceptions.Add(new BaseException(message));
                    }
                }
            }
