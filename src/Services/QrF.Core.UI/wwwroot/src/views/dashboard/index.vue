  ...
  <div class="dashboard-container">
		...
		<el-row class="btn-group">
			<el-col :span="4" class='text-center'>
				<router-link class="pan-btn blue-btn" to="/instore/index">入库</router-link>
			</el-col>
			<el-col :span="4" class='text-center'>
				<router-link class="pan-btn yellow-btn" to="/theme/index">主题</router-link>
			</el-col>
		</el-row>
		<el-row>
			<el-col :span="6">
...
export default {
  name: 'dashboard',
  components: { countTo, panThumb, todoList },
  data() {
    return {
      statisticsData: {
        article_count: 1024,
